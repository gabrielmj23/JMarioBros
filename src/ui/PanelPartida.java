...
public class PanelPartida extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 250, -1, 190));
        ...
        add(SelecPersonaje, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 210, 150, -1));

        jLabel2.setText("Seleccione su personaje:");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 210, -1, 20));

        IniciarBtn.setText("Iniciar Juego");
        IniciarBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                IniciarBtnActionPerformed(evt);
            }
        });
        add(IniciarBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(446, 460, 120, 30));
